...
public class DeliveryService {
    ...
    public static void updateDelivery(String id, String accountId, String groceryId) {
        ...
        assignAccountToGroceryList(id,  account.getUsername());
    ...
    public static void assignAccountToGroceryList(String id, String accountId) {
        Optional<Account> optionalAccount = accountRepository.findById(accountId);
        Optional<GroceryList> optionalGroceryList = groceryListRepository.findById(id);
        if (optionalAccount.isPresent() && optionalGroceryList.isPresent()) {
            Account account = optionalAccount.get();
            GroceryList groceryList = optionalGroceryList.get();
            groceryList.setAccount(account);
            groceryListRepository.save(groceryList);
        } else {
            throw new RecordNotFoundException();
        }
